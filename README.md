...
3. For simplicity, you can directly run the goodmodel_reference.ipynb on [![Open In Colab](https://colab.research.google.com/drive/1fVKeSfyWNd1JXSxkyk1MoIQgqifftZld?usp=sharing) following the code in the notebook.
