...
if __name__ == "__main__":
    ...
    parser.add_argument('--bd_model_path', type=str, default='/content/ML_Cyber_Project_2021/bd_model/anonymous_2_bd_net.h5')
    parser.add_argument('--pruned_model_path', type=str, default='/content/ML_Cyber_Project_2021/fine_pruned_model/anonymous_2_bd_model_pruned.h5')
